...
class Encoder(nn.Module):
    ...
    def forward(self, src, src_mask):
        ...
        # positional embedding을 embedding된 각 token에 summation하여 문장 내 단어들의 위치 정보를 부여
...
class MultiHeadAttentionLayer(nn.Module):
    ...
    def forward(self, query, key, value, mask = None):
        ...
        # query와 key의 유사도 계산 후 너무 큰 값 받지를 위해 scale값으로 normalize 함
        ...
        # attention score matrix와 value를 행렬 연산
        ...
        # 각 head를 concat하여 원래 dimension으로 만듬
